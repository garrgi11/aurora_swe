...
var alertVariants = (0, _classVarianceAuthority.cva)("relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground", {
  variants: {
    variant: {
...
var AlertTitle = exports.AlertTitle = /*#__PURE__*/React.forwardRef(function (_ref2, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)("h5", _objectSpread({
    ref: ref,
