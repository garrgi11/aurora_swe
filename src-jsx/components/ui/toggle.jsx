...
var toggleVariants = exports.toggleVariants = (0, _classVarianceAuthority.cva)("inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors hover:bg-muted hover:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=on]:bg-accent data-[state=on]:text-accent-foreground", {
  variants: {
    variant: {
...
var Toggle = exports.Toggle = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(TogglePrimitive.Root, _objectSpread({
    ref: ref,
